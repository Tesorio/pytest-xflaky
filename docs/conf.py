# pytest-xflaky documentation build configuration file, created by
...
project = 'pytest-xflaky'
copyright = '2015, Tesorio'
author = 'Tesorio'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-xflaky Documentation',
     [author], 1)
]
